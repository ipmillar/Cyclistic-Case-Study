...
The bike dataset contains valuable information about the bike rides, providing details such as the bike type utilized, the start and end locations and times, whether the rider was an annual member or casual rider, and a unique identifier for each bike ride.

The data includes the 13 following columns:
...
We will also be using Chicago Climate data from March 1st, 2020 to February 28th, 2023. This data was made available by the [Visual Crossing Corporation's](https://www.visualcrossing.com/) [Weather Query Builder](https://www.visualcrossing.com/weather/weather-data-services#)

The data encompasses a wide range of meteorological parameters, including location name, date, and time of the weather recordings. Key data elements encompass the daily maximum, minimum, and average temperatures, along with corresponding "feels like" temperatures that factor in humidity and wind conditions. Additional details encompass dew count, humidity levels, precipitation volume, probability, cover, and type, as well as snow-related measurements such as occurrence and depth. Wind characteristics are captured through gusts, direction, and speed. The dataset also includes sea level pressure, cloud cover, visibility, solar radiation levels, solar energy, UV index, severe risk indicators, sunrise, sunset, moon phases, and weather conditions described both succinctly and in terms of corresponding forecast icons.
...
kable(align = "c", caption = "Summary of Average Ride Duration and Distance for Starting Stations", format = "latex") %>%
...
end_summary %>% 
    mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Summary of Average Ride Duration and Distance for Ending Stations", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
rides_bikes_and_member_type %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Duration and Distance by Bike and Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
percent_per_condition_per_member_type %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Rides per Weather Condition Percent per Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
percent_weather_condition_in_chicago %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Percent of Days per Weather Condition in Chicago", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
joined_percent_table %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Percent Days per Weather Condition and Percent Rides Per Weather Condition per Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
conditions_percent_diff %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Percent Difference Between Expected and Actual Ride Percent per Weather Condition by Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
p_cloudy_count %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Partially Cloudy Days per Month", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
ride_per_month_count %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Number of Rides per Month", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
new_p_cloudy_count %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Partially Cloudy Days per Month over Three Years", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
avg_duration %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Ride Duration in Seconds per Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
avg_distance %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Ride Distance in Meters per Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
same_start_and_end_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Number of Rides with the Same Start and End Station per Member Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
annual_start_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Top 10 Start Stations for Annual Members", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
annual_end_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Top 10 End Stations for Annual Members", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
casual_start_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Top 10 Start Stations for Casual Riders", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
casual_end_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Top 10 End Stations for Casual Riders", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
avg_duration_per_rideable_type %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Ride Duration in Seconds per Rideable Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
...
avg_distance_per_rideable_type %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Ride Distance in Meters per Rideable Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
same_start_and_end_stations %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Nubmer of Rides with the Same Start and End Stations by Member and Bike Type", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
...
avg_duration %>% 
  mutate_if(is.numeric, ~comma(.)) %>%
kable(align = "c", caption = "Average Ride Duration in Seconds", format = "latex") %>%
  kable_styling(full_width = F, font_size = 16) %>%
  row_spec(0, bold = TRUE) %>%
  cat("\\resizebox{\\textwidth}{!}{", ., "}\n")
```
